                        ...
                        <div class="card-body">
                            <div class="row">
                               ...
                               @php
                                ...
                                @if($data['CaseOnHold'] == "no")
                                @if($data['ca_approval_status'] == 0 || $data['ca_approval_status'] == 2)
                                <div class="col-md-4 ">
                                    <span class="color_gray"> Order Approval Status</span><br>
                                    <div class="btn-group">
                                      <select name="ca_approval_status" id="ca_approval_status" class="form-control">
                                            <option value="">Approval Status..</option>
                                          
                                           <option value="0" {{ ( 0 ==$data['ca_approval_status']) ? 'selected' : '' }}>Pending</option>
                                           <option value="1" {{ ( 1 ==$data['ca_approval_status']) ? 'selected' : '' }}>Approval</option>
                                           <option value="2" {{ ( 2 ==$data['ca_approval_status']) ? 'selected' : '' }}>Reject</option>
                                        </select>

                                        <a class=" btn btn-warning text-white btn-sm p-0 " style="width: 190px;"
                                            id="approval_status">Update Approval.</a>
                                    </div>
                                </div>
                                @else
                                <div class="col-md-4 ">
                                ...
                                @endif
                                @else
                                <div class="col-md-4 "> <p style="color:red">This order is case on hold</p>
                                </div>
                                @endif
                            ...
                            <div class="col-md-3">
                                ...
                                <button type="button" class="btn btn-warning text-white btn-sm"
                                    data-toggle="modal" data-target="#CAShare">
                                    CA Share
                                </button>
                               </div>
                            </div>
                                ...
                                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                   ...
                                   <li class="nav-item">
                                        <a class="nav-link" id="DOCUMENTSSENTTOCLIENT_tab" data-toggle="pill"
                                            href="#DOCUMENTSSENTTOCLIENT" role="tab" aria-controls="order_priority"
                                    ...
                                    <div class="tab-pane fade active show" id="message_box" role="tabpanel"
                                            ...
                                            <div class="col-md-12 mt-4 overflow mb-2" id="message_box_data">
                                                ...
                                                <div class="post ">
                                                    <div class="user-block mb-1">
                                                        ...
                                                        <span class="description ml-0"> {{ date('d-m-y / H:m:A',
                                                            strtotime($mess->created_at))}}</span>
                                                    </div>
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-6 col-6 text-left mt-1">
                                                <a class="btn btn-warning text-white btn-sm"
                                                    href="{{url('admin/ca_view_order')}}/{{$data['id'] ?? ''}}">Refresh
                                            ...
                                            <div class="col-md-12">
                                                <div class="callout callout-info">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        $doc = DB::table('document_types')->where('status',0)->orderBy('id','DESC')->get();
                                                        @endphp
                                                ...
                                                <div class="callout callout-info">
                                                    ...
                                                    <div class="crad-body p-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 text-right">
                                                                <a class="download-link" href="{{url('admin/download_DOCUMENTS')}}/{{$docDone['id'] ?? '' }}"><i class="fa fa-download" style="font-size:20px"></i></a><br>
                                                                <span>{{ $docDone->created_at}}
                                                                    </span>
                                                            </div>
                                                            <hr>
                                                            @endforeach
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-12 mt-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 text-right">
                                                        <a class="download-link" href="{{url('admin/downloadDoumentsSendByClient')}}/{{$docSend['id'] ?? '' }}"><i class="fa fa-download" style="font-size:20px"></i></a><br>
...
<script>
    $(document).ready(function () {
        ...
        $('#approval_status').on('click', function () {
            ...
            var ca_approval_status = $('#ca_approval_status').val();
            ...
            $.ajax({
                ...
                url: URL + '/CaApprovalStatus',
                data: { order_id: order_id, ca_approval_status: ca_approval_status },
                //dataType: 'json',
                success: function (response) {
                    
                    toastr.success('Approval Status Update successfully');
                  if(ca_approval_status == 1){
                            location.reload();
                    }
                }
            });
        ...
        $('#statusComment_submit').on('click', function () {
            ...
            $.ajax({
                ...
                //dataType: 'json',
                success: function (response) {
                    toastr.success('message Update successfully');
                    $('#status_comment').val('');
                }
            });
        });
        ...
        $('#case_type_submit').on('click', function () {
            var order_id = $('#order_id').val();
            ...
            $.ajax({
                ...
                url: URL + '/orderCaseType',
                data: { order_id: order_id, case_type: case_type },
                //dataType: 'json',
                success: function (response) {
                    toastr.success('Case Type Update successfully');
        ...
        $('#private_comment_Submit').on('click', function () {
            var order_id = $('#order_id').val();
            var private_comment = $('#private_comment').val();
            ...
            $.ajax({
                ...
                url: URL + '/PrivateComment',
                data: { order_id: order_id, private_comment: private_comment },
                //dataType: 'json',
                success: function (response) {
                    toastr.success('Private Comment Update successfully');
