                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; Create Costumars</h3>
                            <div class="card-tools">
                                <a href="{{url ('admin/costumar') }}" class="btn btn-warning text-white btn-sm"><i
                        ...
                        <form id="quickForm" action="{{route('admin.costumar.store')}}"   method="POST" enctype="multipart/form-data">
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Mobile Number<span style="color:red;">*</span></label>
                                         <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile" placeholder="Mobile" value="{{old('name')}}" onkeypress="return isNumber(event)" maxlength="10">
                            ...
                            <div class="col-md-4">
                              ...
                              <!--  <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="aadhar_no" name="aadhar_no" placeholder="Aadhar No." value="{{old('aadhar_no')}}">
