                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-codiepie"></i> &nbsp; Terms & Condition </h3>
                          ...
                          {!! Form::model($setting, ['method' => 'PATCH','files' => true,'route' => ['admin.terms_condition.update', $setting->id]]) !!}
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-12 Label_top">
                                    <label for="Username">Terms & Condition</label>
                                    <textarea  class="form-control ckeditor"  name="terms_and_conditions">{{$setting['terms_and_conditions'] ?? ''}}</textarea>
                		        </div>
