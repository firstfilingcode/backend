                    ...
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            ...
                            <div class="card-tools">
                                <a href="{{url('admin/notification/create')}}" class="btn btn-warning text-white btn-sm"><i
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline">
                                  ...
                                  @foreach($data as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{$value['message'] ?? ''}}</td>
                                             ...
                                             <td>
                                                 @if($value->status==1)
                                                	...
                                                	<button data-toggle="modal" data-target="#Modal_id" data-id="{{ $value->id }}" data-name="Active" class="btn btn-success btn-sm btn-soft-success waves-effect waves-light sa-params notification_status" style ="display:inline">Active</button>
                                             
               								@else
               								  
                                                	<button data-toggle="modal" data-target="#Modal_id" data-id="{{ $value->id }}" data-name="Inactive" class="btn btn-danger btn-sm btn-soft-danger waves-effect waves-light notification_status" style ="display:inline">Inactive</button>
                                               
            								@endif
                                                
                                            </td>
                                            <td class="d-flex">
                                                <a href="{{  route('admin.notification.edit',$value->id)  }}" class=" text-success btn-xs ml-3" title="Edit Notification"><i
                                            ...
                                            {!! Form::open(['method' => 'DELETE','route' => ['admin.notification.destroy', $value->id]]) !!}                                              
                                            {!! Form::close() !!}
        ...
        <div class="modal-content bg_color">
            ...
            <form action="{{ route('admin.notification.destroy')}}" method="post">
                ...
                <div class="modal-body">
                    <input type="hidden" id="notification_delete_id" name="notification_delete_id" />
...
<div class="modal" id="Modal_id">
    <div class="modal-dialog">
        <div class="modal-content bg_color">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.notification.status') }}" method="post">
                @csrf
                <div class="modal-body">
