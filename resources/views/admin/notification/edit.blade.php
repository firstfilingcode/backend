                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; Edit Notification</h3>
                            <div class="card-tools">
                                <a href="{{url ('admin/notification') }}" class="btn bbtn-warning text-white btn-sm"><i
                          ...
                          {!! Form::model($data, ['method' => 'PATCH','files' => true,'route' => ['admin.notification.update', $data->id]]) !!}
                            <div class="row m-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="Username">Message</label>
                                              <textarea class="form-control mt-2" name="message"
                                                id="message" placeholder="Message">{{ $data->message ?? ''}}</textarea>
                                        @error('message')
