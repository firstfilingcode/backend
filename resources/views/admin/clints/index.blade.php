                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a data-id="{{$value->id}}" data-location="countries"
                          class="clint_delete px-2 text-danger sa-params" data-toggle="tooltip" data-placement="top"
...
<script>
    ...
    $('.clint_delete').click(function(){

      $("#clint_dalete_id").val($(this).data('id'))
    ...
    <div class="modal-dialog">
        <div class="modal-content bg_color">
            ...
            <form action="{{ route('admin.clints.destroy')}}" method="post">
                @csrf
                <div class="modal-body">
                    <input type="hidden" id="clint_dalete_id" name="clint_dalete_id" />
