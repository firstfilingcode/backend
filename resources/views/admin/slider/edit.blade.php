                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; Edit Slider</h3>
                            <div class="card-tools">
                                <a href="{{url ('admin/slider') }}" class="btn bbtn-warning text-white btn-sm"><i
                              ...
                              {!! Form::model($data, ['method' => 'PATCH','files' => true,'route' => ['admin.slider.update', $data->id]]) !!}
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-4">
