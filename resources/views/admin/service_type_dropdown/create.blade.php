                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; Create Service Type Dropdown</h3>
                            <div class="card-tools">
                                <a href="{{url ('admin/service_type_dropdown') }}" class="btn btn-warning text-white btn-sm"><i
                        ...
                        <form id="quickForm" action="{{route('admin.service_type_dropdown.store')}}"   method="POST" enctype="multipart/form-data">
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group select2 ">
                                        <label class="">Service Type Id</label>
                                       
                                            <select type="text" class=" w-100 select2-custom teg @error('service_type_id') is-invalid @enderror"   id="service_type_id" name="service_type_id">
