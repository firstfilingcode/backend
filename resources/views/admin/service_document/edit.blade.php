                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; Edit Service Document</h3>
                            <div class="card-tools">
                                <a href="{{url ('admin/service_document') }}" class="btn bbtn-warning text-white btn-sm"><i
                          ...
                          {!! Form::model($data, ['method' => 'PATCH','files' => true,'route' => ['admin.service_document.update', $data->id]]) !!}
                            <div class="row m-2">
                                <div class="col-md-4">
