                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; Create Service Document</h3>
                            <div class="card-tools">
                                <a href="{{url ('admin/service_document') }}" class="btn btn-warning text-white btn-sm"><i
                        ...
                        <form id="quickForm" action="{{route('admin.service_document.store')}}"   method="POST" enctype="multipart/form-data">
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-4">
