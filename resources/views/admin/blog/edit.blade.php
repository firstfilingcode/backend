                    ...
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            ...
                            <div class="card-tools">
                                <a href="{{url ('admin/blog') }}" class="btn bbtn-warning text-white btn-sm"><i
                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="form-group col-md-4">
                                  ...
                                  <input id="thumbnail" class="form-control mt-1" type="file" name="photo">
                                   ...
                                   <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Backlings <span style="color:red;">*</span></label>
                                        <input type="text" class="form-control @error('backlings') is-invalid @enderror" id="backlings" name="backlings" placeholder="Backlings" value="{{old('backlings') ?? $data['backlings']}}">
                                        @error('backlings')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
