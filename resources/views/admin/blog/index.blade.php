                    ...
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            ...
                            <div class="card-tools">
                                <a href="{{url('admin/blog/create')}}" class="btn btn-warning text-white btn-sm"><i
                                  ...
                                  @foreach($data as $key => $value)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                <a data-id="{{$value->id}}"  data-location="countries"  class="blog_delete text-danger btn-xs ml-3" data-toggle="tooltip" data-placement="top" title="Delete" onclick="document.getElementById('id01').style.display='block'"><i class="fa fa-trash-o"></i></a>
        ...
        <div class="modal-content bg_color">
            ...
            <form action="{{ route('admin.blog.destroy')}}" method="post">
                ...
                <div class="modal-body">
                    <input type="hidden" id="blog_delete_id" name="blog_delete_id" />
...
<script>
    ...
    $('.blog_delete').click(function(){
      ...
      $("#blog_delete_id").val($(this).data('id'))
