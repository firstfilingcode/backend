                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="Username">Page Name</label>
                                              ...
                                              <select name="page_name" id="page_name" class="mt-2 form-control @error('page_name') is-invalid @enderror teg"  >
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="Username">Answer</label>
                                              <textarea class="form-control mt-2 " name="answer"
                                                id="answer" placeholder="Answer"></textarea>
                                        @error('answer')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
