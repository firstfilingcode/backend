                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; Edit Email Tamplate</h3>
                        ...
                        ['admin.templete_view.update', $data->id]])
                        !!}
                        @csrf
                        <div class="row m-2">
                               <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control " name="category" id="category">
                                    ...
                                    <option value="rm_assign" {{ ( "rm_assign" == $data['category'] ?? '') ? 'selected' : '' }}>Rm Assign</option>
                                    <option value="rm_assign_users_email" {{ ( "rm_assign_users_email" == $data['category'] ?? '') ? 'selected' : '' }}>Rm Assign Users Email</option>
                                    <option value="ca_assign" {{ ( "ca_assign" == $data['category'] ?? '') ? 'selected' : '' }}>Ca Assign</option>
                                    <option value="ca_assign_users_email" {{ ( "ca_assign_users_email" == $data['category'] ?? '') ? 'selected' : '' }}>Ca Assign Users Email</option>
                                    <option value="ca_assign_rm_email" {{ ( "ca_assign_rm_email" == $data['category'] ?? '') ? 'selected' : '' }}>Ca Assign Rm Email</option>
                                    <option value="rm_chat" {{ ( "rm_chat" == $data['category'] ?? '') ? 'selected' : '' }}>Rm chat</option>
                                    <option value="ca_chat" {{ ( "ca_chat" == $data['category'] ?? '') ? 'selected' : '' }}>Ca chat</option>
                                    <option value="users_chat" {{ ( "users_chat" == $data['category'] ?? '') ? 'selected' : '' }}>Users chat</option>
                         ...
                         <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control " name="title" id="title"  value="{{old('title',$data['title'] ) ?? ''}}">
                                 ...
                                 <table class="_table" id="tableId"style="width: 85%;margin-left: 8%;margin-top: 5%;">
                                    ...
                                    <tbody id="table_body" >
                                      <tr id="box2" >
                                        ...
                                        <td >
                                            <textarea class="form-control ckeditor" name="email_description" id="email_description">{{$data ['email_description'] ?? ''}}</textarea>
