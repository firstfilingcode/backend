          ...
          <div class="card card-outline card-orange">
            <div class="card-header bg-primary">
              ...
              <div class="card-tools">
               <!-- <a href="{{url('admin/templete_view/create')}}" class="btn btn-warning text-white btn-sm"><i
                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline">
                  ...
                  <tbody class="product_list_show">
                    ...
                    <tr>
                        ...
                        <td>{!!html_entity_decode($value['email_description'] ?? '')!!}</td>
                       
                      
                      <td>
                        <a href="{{  route('admin.templete_view.edit',$value->id)  }}" class=" text-success btn-xs ml-3"
                       ...
                       <!-- <a data-id="{{$value->id}}" data-location="countries"
                        ...
                        {!! Form::open(['method' => 'DELETE','route' => ['admin.templete_view.destroy',
...
<script>
    ...
    $('.event_delete').click(function(){
      ...
      $("#emailtemplate_dalete_id").val($(this).data('id'))
...
<div class="modal" id="Modal_id1">
    <div class="modal-dialog">
        <div class="modal-content bg_color">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.templete_view.destroy')}}" method="post">
                @csrf
                <div class="modal-body">
                    <input type="hidden" id="emailtemplate_dalete_id" name="emailtemplate_dalete_id" />
