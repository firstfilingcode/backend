                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-balance-scale"></i> &nbsp;Order Priority</h3>
                        ...
                        <form id="quickForm" action="{{route('admin.order_priority.store')}}"   method="POST" enctype="multipart/form-data">
                           @csrf
                            <div class="row m-2">
