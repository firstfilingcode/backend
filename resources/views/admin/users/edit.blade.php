                                        ...
                                        <div class="p-4 border-top">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                                    ...
                                                                    <input type="password" class="form-control input-psswd @error('password') is-invalid @enderror" placeholder="Password" psswd-shown="false"  value="{{old('password',$user['show_password']) ?? ''}}" style="background-color: #fff;">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        @if(!empty($sidebar)) 
                                                                            ...
                                                                            <input name="sidebar_id[]" class="custom-control-input custom-control-input-primary custom-control-input-outline checkbox " type="checkbox" id="sidebar{{ $sideba->id ?? '' }}" @if(in_array($sideba->id,$Sidebar)) checked="" @endif value="{{ $sideba->id ?? '' }}">
                                                                            <label for="sidebar{{ $sideba->id ?? '' }}" class="custom-control-label pointer">{{ $sideba->name ?? '' }}</label>
                                                                            </div>                                                
                                                                            @endforeach
                                                                        @endif
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group" >
                                                                        ...
                                                                        @if(!empty($sidebar_sub_menu)) 
                                                                            ...
                                                                            <div class="custom-control custom-checkbox ">
                                                                            <input name="sub_menu_id[]" class="custom-control-input custom-control-input-primary custom-control-input-outline checkbox2" type="checkbox" id="id_{{ $sidebar_sub->id ?? '' }}" @if(in_array($sidebar_sub->id,$SidebarSub)) checked=""  @endif value="{{ $sidebar_sub->id ?? '' }}">
