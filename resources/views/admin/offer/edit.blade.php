            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                       ...
                       {!! Form::model($data, ['method' => 'PATCH','files' => true,'route' => ['admin.offer.update', $data->id]]) !!}
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('name') is-invalid @enderror @error('name') is-invalid @enderror mt-1" id="from_date" name="from_date" placeholder="From Date" value="{{old('from_date') ?? $data['from_date'] }}">
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('name') is-invalid @enderror @error('name') is-invalid @enderror mt-1" id="to_date" name="to_date" placeholder="To Date" value="{{old('to_date') ?? $data['to_date'] }}">
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                  ...
                                  <input id="thumbnail" class="form-control mt-1" type="file" name="photo">
                                   ...
                                   <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror @error('name') is-invalid @enderror mt-1" id="promo_code" name="promo_code" placeholder="Promo Code" value="{{old('promo_code') ?? $data['promo_code'] }}">
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
