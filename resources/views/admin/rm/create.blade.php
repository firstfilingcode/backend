                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; Create RM</h3>
                        ...
                        <form id="quickForm" action="{{route('admin.rm.store')}}"   method="POST" enctype="multipart/form-data">
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Mobile Number<span style="color:red;">*</span></label>
                                         <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile" placeholder="Mobile" value="{{old('mobile')}}" onkeypress="return isNumber(event)" maxlength="10">
                              ...
                              <!--  <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control text_arear @error('address') is-invalid @enderror" id="address" name="address"  placeholder="Addresh" value="{{old('address')}}"></textarea>
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
