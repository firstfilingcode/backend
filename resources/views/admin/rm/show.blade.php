                    ...
                    <div class="card card-outline card-orange">
                       ...
                       <div class="row m-2">
                            ...
                            <div class="col-6">
                              <div class="row">
                                  @php
                                    $order = DB::table('order_details')->where('rm_user_id',$data['id'])->count();;
                                    @endphp
                                    <div class="col-12 col-sm-6 col-md-6">
                                     ...
                                     @php
                                        $panding_order = DB::table('order_details')->where('status',1)->where('rm_user_id', $data['id'])->count();
                                    @endphp
                                  <div class="col-12 col-sm-6 col-md-6">
                                  <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
                                       <input type="hidden" name="rm_user_id" value="{{$data['id']}}">
                                ...
                                @php
                                    $under = DB::table('order_details')->whereNotIn('order_details.status',[1,23,24])->where('rm_user_id', $data['id'])->count();
                                @endphp
                                 <div class="col-12 col-sm-6 col-md-6">
                                    <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
                                 ...
                                 @php
                                    $caseOnHold = DB::table('order_details')->where('status',23)->where('rm_user_id', $data['id'])->count();
                                @endphp
                                 <div class="col-12 col-sm-6 col-md-6">
                                    <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
                                 ...
                                 @php
                                    $total_order = DB::table('order_details')->where('status',24)->where('rm_user_id', $data['id'])->count();
                                @endphp
                                 <div class="col-12 col-sm-6 col-md-6">
                                    <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
