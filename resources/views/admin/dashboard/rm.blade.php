            ...
            <div class="col-12 col-md-12">
               <div class="card card-outline card-orange">
                  <div class="card-header bg-primary">
                     <h3 class="card-title"><i class="fa fa-home"></i> &nbsp;Rm Dashboard</h3>
             ...
             <div class="row">
                                  @php
                                    $order = DB::table('order_details')->where('rm_user_id',Auth::user()->id)->count();;
                                    @endphp
                                    <div class="col-12 col-sm-6 col-md-3">
                                        <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
                                       <input type="hidden" name="rm_user_id" value="{{Auth::user()->id}}">
                                     ...
                                     @php
                                        $panding_order = DB::table('order_details')->where('status',1)->where('rm_user_id', Auth::user()->id)->count();
                                    @endphp
                                  <div class="col-12 col-sm-6 col-md-3">
                                  <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
                                ...
                                @php
                                    $under = DB::table('order_details')->whereNotIn('order_details.status',[1,23,24])->where('rm_user_id', Auth::user()->id)->count();
                                @endphp
                                 <div class="col-12 col-sm-6 col-md-3">
                                    <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
                                 ...
                                 @php
                                    $caseOnHold = DB::table('order_details')->where('status',23)->where('rm_user_id', Auth::user()->id)->count();
                                @endphp
                                 <div class="col-12 col-sm-6 col-md-3">
                                    <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
                                 ...
                                 @php
                                    $total_order = DB::table('order_details')->where('status',24)->where('rm_user_id', Auth::user()->id)->count();
                                @endphp
                                 <div class="col-12 col-sm-6 col-md-3">
                                    <form id="quickForm" action="{{url('admin/order')}}"   method="POST" enctype="multipart/form-data">
                                          @csrf
                                       ...
                                       <input type="hidden" name="status_id" value="24">
                                      <div class="info-box mb-3 text-dark">
                                         <span class="info-box-icon bg-success elevation-1"><i class="fa fa-check"></i></span>
                                         <div class="info-box-content">
